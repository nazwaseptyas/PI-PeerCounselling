                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="contacts-us-wrapper theme-green">
                            <form id="contacts-us-form" class="contacts-us-form" onsubmit="simpan()">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="contacts-icon contactss-phone">
                                            <input name="nohp" type="number" placeholder="Masukkan Nomor Telepon" />
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 d-flex justify-content-center">
                                            <div class="contacts-us-form-button text-center">
                                                <button class="c-btn" type="submit">Kirim</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
